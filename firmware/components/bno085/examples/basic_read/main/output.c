...
static bool print_csv_value(const bno085_sensor_value_t *value, bool first)
{
    ...
    switch (value->sensor_id) {
        ...
        case BNO085_SENSOR_GAME_ROTATION_VECTOR: {
            ...
            #else
            float roll, pitch, yaw;
            bno085_quaternion_to_euler(value->data.game_rotation_vector.i, value->data.game_rotation_vector.j,
        ...
        case BNO085_SENSOR_GEOMAGNETIC_ROTATION_VECTOR: {
            ...
            #else
            float roll, pitch, yaw;
            bno085_quaternion_to_euler(value->data.geomagnetic_rotation_vector.i, value->data.geomagnetic_rotation_vector.j,
        ...
        case BNO085_SENSOR_AR_VR_STABILIZED_RV: {
            ...
            #else
            float roll, pitch, yaw;
            bno085_quaternion_to_euler(value->data.ar_vr_stabilized_rv.i, value->data.ar_vr_stabilized_rv.j,
        ...
        case BNO085_SENSOR_GYRO_INTEGRATED_RV: {
            ...
            #else
            float roll, pitch, yaw;
            bno085_quaternion_to_euler(value->data.gyro_integrated_rv.i, value->data.gyro_integrated_rv.j,
